  ...
  const projects: ProjectData[] = [
    {
      ...
      skillImages: ['../icons/React.png', '../icons/mongodb.png', '../icons/expo1.png'],
      content: 'Full stack movie app made in React Native, the user gets a list of popular movies and can search for them too. They can add the movie to a watchlist and in the watchlist they can mark the movie as watched and they can give it a score This was an Expert Lab project made for school.',
